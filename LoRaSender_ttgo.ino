...
byte pinDHT11 = 12; //or pin 13/25 see https://rntlab.com/question/esp32-heltec-with-dht22/
String rssi = "RSSI --";
String packSize = "--";
String packet ;
...
void loop() {
 ...
 void TEMPERATURA(){
  dht11.read2(pinDHT11, &temperature, &humidity, NULL);
  Serial.print("t= ");
  ...
  // Display Info
  Display.clearBuffer();  
  Display.setCursor(0,12); Display.print("Temperatura");
  Display.setCursor(0,26); Display.print("#" + (String)temperature); 
  Display.setCursor(0,42); Display.print("Humedad");
  Display.setCursor(0,58); Display.print("#" + (String)humidity); 
  Display.sendBuffer();
